...
##Co-authored manuscripts in preparation or review

1. Robinson, S.K., **J.L Burnett**, and A. Kratter. *in prep* Population trends of birds of a North Florida Christmas Bird Count: Gainesville, FL. 


## R Packages ([see GitHub for additional projects](https://github.com/TrashBirdEcology))
**Burnett, J.L.**, N.B. Price. 2018. [*regimeDetectionMeasures*](https://github.com/TrashBirdEcology/regimeDetectionMeasures). R package for calculating univariate and multivariate regime detection methods using community time series.

**Burnett, J.L.** 2019.  [*bbsRDM*](https://github.com/TrashBirdEcology/bbsRDM). R package for accessing, downloading, and analyzing the North American Breeding Bird Survey using the *regimeDetectionMeasure* package.

**Burnett, J.L.**, N.B. Price. 2018. [*distanceTraveled*](https://github.com/TrashBirdEcology/distanceTravelled). R package for calculating the distance traveled by a multispecies community along a time series. 
